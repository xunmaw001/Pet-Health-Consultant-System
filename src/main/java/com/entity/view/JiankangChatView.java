...
public class JiankangChatView extends JiankangChatEntity implements Serializable {
	...
	*/
	...
	private String jiankangChatValue;
	...
	public JiankangChatView() {

	}

	public JiankangChatView(JiankangChatEntity jiankangChatEntity) {
		try {
			BeanUtils.copyProperties(this, jiankangChatEntity);
	...
	* 获取： 数据类型的值
	*/
	public String getJiankangChatValue() {
		return jiankangChatValue;
	}
	/**
	* 设置： 数据类型的值
	*/
	public void setJiankangChatValue(String jiankangChatValue) {
		this.jiankangChatValue = jiankangChatValue;
	}
	...
	public String toString() {
		return "JiankangChatView{" +
			", zhuangtaiValue=" + zhuangtaiValue +
			", jiankangChatValue=" + jiankangChatValue +
