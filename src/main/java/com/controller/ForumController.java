...
, "usersId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            ...
            //级联表 顾问
            //级联表
            GuwenEntity guwen = guwenService.selectById(forum.getGuwenId());
            if(guwen != null){
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setGuwenId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
...
//                            forumEntity.setGuwenId(Integer.valueOf(data.get(0)));   //顾问 要改的
