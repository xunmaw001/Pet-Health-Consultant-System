...
//                            guwenYuyueEntity.setGuwenYuyueText(data.get(0));                    //报名理由 要改的
//                            guwenYuyueEntity.setGuwenYuyueYesnoTypes(Integer.valueOf(data.get(0)));   //报名状态 要改的
...
//                            guwenYuyueEntity.setGuwenYuyueTime(sdf.parse(data.get(0)));          //预约时间 要改的
...
//                            guwenYuyueEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestBody GuwenYuyueEntity guwenYuyue, HttpServletRequest request){
        ...
        Wrapper<GuwenYuyueEntity> queryWrapper = new EntityWrapper<GuwenYuyueEntity>()
            .eq("guwen_yuyue_uuid_number", guwenYuyue.getGuwenYuyueUuidNumber())
            .eq("guwen_id", guwenYuyue.getGuwenId())
            .eq("yonghu_id", guwenYuyue.getYonghuId())
            .eq("guwen_yuyue_text", guwenYuyue.getGuwenYuyueText())
            .in("guwen_yuyue_yesno_types", new Integer[]{1,2})
            .eq("guwen_yuyue_yesno_text", guwenYuyue.getGuwenYuyueYesnoText())
//            .notIn("guwen_yuyue_types", new Integer[]{102})
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        GuwenYuyueEntity guwenYuyueEntity = guwenYuyueService.selectOne(queryWrapper);
        if(guwenYuyueEntity==null){
