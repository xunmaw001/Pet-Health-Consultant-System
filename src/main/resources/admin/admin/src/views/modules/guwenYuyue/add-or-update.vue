    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报名理由" prop="guwenYuyueText">
                        <el-input type="textarea"  :readonly="ro.guwenYuyueText" v-model="ruleForm.guwenYuyueText" placeholder="报名理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.guwenYuyueText" label="报名理由" prop="guwenYuyueText">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.guwenYuyueYesnoTypes" label="报名状态" prop="guwenYuyueYesnoTypes">
                        <el-input v-model="ruleForm.guwenYuyueYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
            ...
            <el-col :span="12" v-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="预约时间" prop="guwenYuyueTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.guwenYuyueTime" label="预约时间" prop="guwenYuyueTime">
