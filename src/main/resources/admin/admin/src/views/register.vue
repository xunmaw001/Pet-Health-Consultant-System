    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">宠物健康顾问系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='guwen'">
...
<style lang="scss" scoped>
	...
	.container {
        ...
        background-image: url(/chongwujiankangguwen/img/back-img-bg.jpg);
